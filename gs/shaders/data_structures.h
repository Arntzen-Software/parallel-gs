...
CONSTEXPR int PGS_RASTER_SUBPIXELS = 1 << PGS_RASTER_SUBSAMPLE_BITS;

// Used for triangle setup. Quantize the equations since we will never evaluate at full 16x grid.
CONSTEXPR int PGS_SUBPIXEL_QUANTIZE_BITS = PGS_SUBPIXEL_BITS - PGS_RASTER_SUBSAMPLE_BITS;
CONSTEXPR int PGS_SUBPIXELS_RASTER_QUANTIZE = 1 << PGS_SUBPIXEL_QUANTIZE_BITS;
