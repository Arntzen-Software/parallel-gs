...
CONSTEXPR int SUBPIXELS = 1 << SUBPIXEL_BITS;

// Allows us to interpolate and test rasterization with 1/8th pixel precision.
// Can allow for 8x upscale.
CONSTEXPR int RASTER_SUBSAMPLE_BITS = 3;
CONSTEXPR int SUBPIXEL_RASTER_BITS = SUBPIXEL_BITS - RASTER_SUBSAMPLE_BITS;
CONSTEXPR int SUBPIXELS_RASTER = 1 << SUBPIXEL_RASTER_BITS;
...
CONSTEXPR int FB_SWIZZLE_WIDTH_LOG2 = 3;
CONSTEXPR int FB_SWIZZLE_HEIGHT_LOG2 = 3;
CONSTEXPR int FB_SWIZZLE_WIDTH = 1 << FB_SWIZZLE_WIDTH_LOG2;
CONSTEXPR int FB_SWIZZLE_HEIGHT = 1 << FB_SWIZZLE_HEIGHT_LOG2;
CONSTEXPR int FB_SWIZZLE_BLOCK_SIZE = FB_SWIZZLE_WIDTH * FB_SWIZZLE_HEIGHT;

CONSTEXPR int BLOCK_ALIGNMENT_WORDS = 64;
CONSTEXPR int PAGE_ALIGNMENT_WORDS = 2048;
CONSTEXPR int BLOCK_ALIGNMENT_BYTES = BLOCK_ALIGNMENT_WORDS * 4;
CONSTEXPR int PAGE_ALIGNMENT_BYTES = PAGE_ALIGNMENT_WORDS * 4;
CONSTEXPR int BLOCKS_PER_PAGE = PAGE_ALIGNMENT_WORDS / BLOCK_ALIGNMENT_WORDS;
CONSTEXPR int CLUT_SIZE = 1024;
CONSTEXPR int CLUT_INSTANCES = 1024;

// FBW / TBW, etc. Basically intended to match page width,
// but edge case for tiny formats like PSMT4, etc.
CONSTEXPR int BUFFER_WIDTH_SCALE = 64;
...
CONSTEXPR int STATE_BIT_Z_WRITE = 17;
...
CONSTEXPR int STATE_BIT_OPAQUE = 18;
CONSTEXPR int STATE_BIT_PARALLELOGRAM = 19;
CONSTEXPR int STATE_BIT_MULTISAMPLE = 20;
CONSTEXPR int STATE_BIT_Z_TEST_GREATER = 21;
CONSTEXPR int STATE_BIT_PERSPECTIVE = 22;
CONSTEXPR int STATE_BIT_IIP = 23;
CONSTEXPR int STATE_BIT_FIX = 24;
CONSTEXPR int STATE_BIT_SPRITE = 25;
CONSTEXPR int STATE_BIT_LINE = 26;
CONSTEXPR int STATE_BIT_SCANMSK_EVEN = 27;
CONSTEXPR int STATE_BIT_SCANMSK_ODD = 28;
CONSTEXPR int STATE_BIT_SNAP_RASTER = 29;
CONSTEXPR int STATE_BIT_SNAP_ATTRIBUTE = 30;
...
CONSTEXPR int VARIANT_FLAG_INVARIANT_FP_BIT = 1 << 1;
CONSTEXPR int VARIANT_FLAG_HIZ_BIT = 1 << 2;
CONSTEXPR int VARIANT_FLAG_HAS_AA1_BIT = 1 << 3;
CONSTEXPR int VARIANT_FLAG_HAS_SCANMSK_BIT = 1 << 4;
