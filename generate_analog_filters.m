...
ntsc_chroma_lp_decode = firls(26, [0, ntsc_chroma_bw, ntsc_chroma_stop, bt601_rate] / bt601_rate, [1 1 0 0])';
...
ntsc_luma_lp_decode = firls(28, [0, ntsc_luma_bw, ntsc_luma_stop, bt601_rate] / bt601_rate, [1 1 0 0]);
subcarrier_notch = real(conv([1, -subcarrier_zero], [1, -conj(subcarrier_zero)]));
subcarrier_notch = subcarrier_notch' / sum(subcarrier_notch);
...
pal_chroma_lp_decode = firls(26, [0, pal_chroma_bw, pal_chroma_stop, bt601_rate] / bt601_rate, [1 1 0 0])';
...
pal_luma_lp_decode = firls(28, [0, pal_luma_bw, pal_luma_stop, bt601_rate] / bt601_rate, [1 1 0 0]);
subcarrier_notch = real(conv([1, -subcarrier_zero], [1, -conj(subcarrier_zero)]));
subcarrier_notch = subcarrier_notch' / sum(subcarrier_notch);
...
assert(length(pal_luma_lp_decode) == 31, "Length must be 31");
